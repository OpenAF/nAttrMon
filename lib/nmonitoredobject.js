...
// ----------------------------------------
nMonitoredObject.prototype.determineType = function(anObject) {
	if (isUndefined(anObject)) anObject = this.obj
	if (anObject instanceof AF) { return "AF"; }
	if (anObject instanceof DB) { return "DB"; }
	try { if (anObject instanceof HTTPd) { return "HTTPd"; } } catch(e) { }
	try { if (anObject instanceof SSH) { return "SSH"; } } catch(e) { }
	try { if (anObject instanceof JMXServer) { return "JMXServer"; } } catch(e) { }
	try { if (anObject instanceof SNMPServer) { return "SNMPServer"; } } catch(e) { }
	try { if (anObject instanceof SVN) { return "SVN"; } } catch(e) { }
}
...
nMonitoredObject.prototype.test = function() {
	if (this.dirty) {
		try {
			...
			try {
				try { this.tryToClose(this.obj) } catch(ee) {}
				this.obj = this.func()
