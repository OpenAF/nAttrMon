// nAttrMon attributes functionality
...
nAttributes.prototype.setAttribute = function(anAttribute) {
	if (isUnDef(anAttribute) || Object.keys(anAttribute).length === 0) return
...
// Replace current attributes with a snapshot
// ----------------------------------------
// anAttributesSnapshot = array of attribute structs
// ----------------------------------------
...
nAttributes.prototype.exists = function(anAttributeName) {
	return isDef($ch(this.chAttributes).get({ name: anAttributeName }))
}
