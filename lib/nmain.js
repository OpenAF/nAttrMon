...
var __nam_getChExtraOptions = aMap => {
	if (aMap.type == "elasticsearch") { aMap.options.idKey = "id"; aMap.options.size = 10000; aMap.options.fnId = k => { return sha256(stringify(k, __, true)) } } 
	return aMap;
}
