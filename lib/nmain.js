...
nAttrMon.prototype.loadPlugs = function() {
	...
	if (!__NAM_NOPLUGFILES) this.loadPlugDir(this.configPath + "/inputs", "inputs", ignoreList)
	if (!__NAM_NOPLUGFILES) this.loadPlugDir(this.configPath + "/validations", "validations", ignoreList)
	if (!__NAM_NOPLUGFILES) this.loadPlugDir(this.configPath + "/outputs", "outputs", ignoreList)
};
