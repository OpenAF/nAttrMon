// Phase 7 -- nOutput_HistPrometheus.js pure-logic coverage: metric-name
...
var __newPromInstance = (overrides) => {
	load(NATTRMON_HOME + "/config/objects/nOutput_HistPrometheus.js")
	var o = Object.create(nOutput_HistPrometheus.prototype)
...
ow.test.test("nOutput_HistPrometheus::_metricName sanitizes non-alphanumerics like nOutput_HTTP_Metrics does", () => {
...
ow.test.test("nOutput_HistPrometheus::_adaptiveStep widens step to stay under maxPoints for wide windows", () => {
...
ow.test.test("nOutput_HistPrometheus::_parseRangeResponse returns [] on error status without throwing", () => {
	var o = __newPromInstance()
	ow.test.assert(o._parseRangeResponse({ status: "error", error: "boom" }, "num"), [], "error responses should not throw, just return []")
})

ow.test.test("nOutput_HistPrometheus::_parseRangeResponse returns [] on empty matrix (the normal 'not a scalar' signal)", () => {
	var o = __newPromInstance()
...
ow.test.test("nOutput_HistPrometheus::_parseRangeResponse parses a populated scalar matrix, newest first", () => {
	var o = __newPromInstance()
	var raw = { status: "success", data: { resultType: "matrix", result: [
...
ow.test.test("nOutput_HistPrometheus::_parseRangeResponse coerces semaphore-typed values to boolean", () => {
	var o = __newPromInstance()
	var raw = { status: "success", data: { resultType: "matrix", result: [
...
ow.test.test("nOutput_HistPrometheus::_parseMapRangeResponse reconstructs a flat map from leaf series", () => {
	var o = __newPromInstance()
	var raw = { status: "success", data: { resultType: "matrix", result: [
...
ow.test.test("nOutput_HistPrometheus::_parseMapRangeResponse returns [] when nothing matched the wildcard", () => {
	var o = __newPromInstance()
	var raw = { status: "success", data: { resultType: "matrix", result: [] } }
...
ow.test.test("nOutput_HistPrometheus::getValuesByEvents slices the N most recent samples", () => {
...
ow.test.test("nOutput_HistPrometheus::getValuesByEvents returns fewer than N without throwing when the window is short", () => {
